...
import 'package:uber_clone_app/view/login/add_vehicle_view.dart';
...
class DocumentUploadView extends StatefulWidget {
  ...
  @override
  State<DocumentUploadView> createState() => _DocumentUploadView();
}

class _DocumentUploadView extends State<DocumentUploadView> {
  List documentList = [
    {
